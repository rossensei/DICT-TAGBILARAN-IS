...
//     axios.get(`/api/${props.category.id}/subcategories`)
// }
</script>
<template>
    <li>
                ...
                <div class="flex space-x-3" :class="{ 'items-center' : editMode }">
                    ...
                    <div class="shrink-0">
                        ...
                        <div v-if="!editMode" class="space-x-3">
                            <button type="button" @click="editCategory"><i class="fa-solid fa-pencil"></i></button>
                        ...
                        <div v-else class="space-x-3">
                            ...
                            <button type="button" @click="cancelEdit"><i class="fa-solid fa-xmark"></i></button>
                        </div>
                    </div>
                </div>
